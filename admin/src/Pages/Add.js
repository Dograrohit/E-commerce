...
const Add = () => {
  ...
  return (
    <>
      <form onSubmit={onsubmitHandler} className='flex flex-col w-full item-start gap-5'>
        <div>
           <p className='mb-5'>Upload Image</p>

           <div className='flex gap-5'>
             <label htmlFor='image1'>
                <img className='w-[10rem]' src={!image1 ? assets.upload_area : URL.createObjectURL(image1)} alt=''></img>
                <input onChange={(e)=>setImage1(e.target.files[0])} type='file' id='image1' hidden></input>
             </label>
             <label htmlFor='image2'>
                <img className='w-[10rem]' src={!image2 ? assets.upload_area : URL.createObjectURL(image2)} alt=''></img>
                <input onChange={(e)=>setImage2(e.target.files[0])} type='file' id='image2' hidden></input>
             </label>
             <label htmlFor='image3'>
                <img className='w-[10rem]' src={!image3 ? assets.upload_area : URL.createObjectURL(image3)} alt=''></img>
                <input onChange={(e)=>setImage3(e.target.files[0])} type='file' id='image3' hidden></input>
             </label>
             <label htmlFor='image4'>
                <img className='w-[10rem]' src={!image4 ? assets.upload_area : URL.createObjectURL(image4)} alt=''></img>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
           ...
           <div>
             ...
             <select onChange={(e)=>setCategory(e.target.value)} className='w-full max-w-[200px] px-3 py-2'>
           ...
           <div>
             ...
             <input onChange={(e)=>setPrice(e.target.value)} className='w-full sm:w-[150px] px-3 py-2' type='Number' placeholder='25'></input>
           </div>
